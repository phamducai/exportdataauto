...
# end_date = today
start_date = datetime(2024, 8, 1)  # Ngày 1 tháng 8 năm 2024
end_date = datetime(2024, 9, 1)   
# Truy vấn SQL
query_template = """
SELECT
  DSMART90.dbo.DsTransNoFSPTransNo ( a.Trans_No ) AS tran_num,
...
FROM
  DSMART90_ARC.dbo.STr_Payment_202408 a
  JOIN DSMART90_ARC.dbo.STr_Hdr_202408 b ON a.Trans_No= b.Trans_No 
WHERE 
