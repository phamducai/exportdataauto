...
# Tính toán ngày 26 của tháng trước và ngày 1 của tháng này
today = datetime.now()
first_day_of_current_month = today.replace(day=1)
previous_month = first_day_of_current_month - timedelta(days=1)
twenty_sixth_last_month = previous_month.replace(day=26)
...
# Trừ 1 ngày từ end_date_str để sử dụng trong tên file
# end_date_for_filename = (first_day_of_current_month - timedelta(days=1)).strftime("%Y-%m-%d")
