...
def fetch_sales_data():
    ...
    current_date = datetime.now() - timedelta(days=subdate)
...
def send_email(daily_df, avg_df, recipients=['sales_data@famima.vn','n-kikunaga@famima.vn','t-tsuji204@family.co.jp','y-hirao@family.co.jp','a-kirimura@family.co.jp','s-odake855@family.co.jp','t-suzuki984@family.co.jp','b-gen@family.co.jp','duong.pdh@famima.vn','truong.tk@famima.vn','hien.dtn@famima.vn','a-okada759@family.co.jp']):
    try:
        ...
        current_date = (datetime.now()-timedelta(days=subdate)).strftime("%Y-%m-%d")
