...
last_day_of_previous_month_1 = first_day_of_current_month - timedelta(days=0)
sixteenth_of_previous_month = last_day_of_previous_month.replace(day=16)

start_date_str = sixteenth_of_previous_month.strftime("%Y-%m-%d")
end_date_str = last_day_of_previous_month.strftime("%Y-%m-%d")
end_date_str_1 = last_day_of_previous_month_1.strftime("%Y-%m-%d")
